...
public class ShortcutManager {
    ...
    private static void addShortcut(Context context) {
        ...
        final Parcelable iconResource = Intent.ShortcutIconResource.fromContext(context, R.mipmap.player);

        final Intent intent = new Intent();
        intent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, shortcutIntent);
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, context.getResources().getString(R.string.app_name_free));
